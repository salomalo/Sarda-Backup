...
jQuery(document).ready(function () {
    ...
    jQuery('#export_images_zip_button').click(function () {
        if (jQuery("select[name=v_export_images_zip]").val() == 1) {
            window.open(woocommerce_product_csv_import_params.siteurl + '/wp-admin/admin.php?page=wf_woocommerce_csv_im_ex&action=export_images', '_blank')
        }
    });
});