...
class WF_ProdImg_Exporter {
    ...
    public static function do_export($post_type = 'product', $prod_ids = array()) {
        ...
        $wf_export_images = WF_ProdImg_Exporter::get_all_products_images();
        ...
        if ($wf_export_images) {
            if (!strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') {
                ...
                $zip_res = WF_ProdImg_Exporter::Zippp($wf_export_images, $destination);
            }
    ...
    public static function get_all_products_images() {
        ...
        if ($products || !is_wp_error($products)) {
            foreach ($products as $key => $product) {
                $attachments = WF_ProdImg_Exporter::getProductImages($product);
