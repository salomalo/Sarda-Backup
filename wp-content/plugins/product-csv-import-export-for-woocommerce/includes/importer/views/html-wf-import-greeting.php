...
<div class="woocommerce">
    <h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
        <a href="<?php echo admin_url('admin.php?page=wf_woocommerce_csv_im_ex') ?>" class="nav-tab nav-tab-active"><?php _e('Product', 'wf_csv_import_export'); ?></a>
        <a href="<?php echo admin_url('admin.php?page=wf_pr_rev_csv_im_ex&tab=review') ?>" class="nav-tab "><?php _e('Product Reviews ', 'wf_csv_import_export'); ?></a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="description"><?php _e('check this box to avoid the regeneration of thumbnails on import', 'wf_csv_import_export'); ?></span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="description"><?php _e(' Check this to link grouped products using product SKUs instead of product IDs', 'wf_csv_import_export'); ?></span>
                                    </td>
                                </tr>
