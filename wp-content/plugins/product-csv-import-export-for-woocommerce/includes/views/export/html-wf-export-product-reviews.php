        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p style="font-size: 12px"><?php _e('The number of product reviews you wish to import', 'wf_csv_import_export'); ?></p>
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p style="font-size: 12px"><?php _e('import reviews for the selected specific products', 'wf_csv_import_export'); ?></p>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    ...
                    <p style="font-size: 12px"><?php _e('Import reviews for the selected specific number of stars', 'wf_csv_import_export'); ?></p>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    ...
                    <p style="font-size: 12px"><?php _e('Select to whether import reviews of only verified owners', 'wf_csv_import_export'); ?></p>
                </td>
            </tr>
            <tr>
                <th>
                    <label for="v_replycolumn"><?php _e('Check to enable exporting reviews with replies', 'wf_csv_import_export'); ?></label>
                </th>
                <td>
                ...
                <td>
                    ...
                    <p style="font-size: 12px"><?php _e('The delimiter to separate the columns by in the CSV file. ‘Comma’ by default', 'wf_csv_import_export'); ?></p>
                </td>
            </tr>
            <tr>
                <th>
