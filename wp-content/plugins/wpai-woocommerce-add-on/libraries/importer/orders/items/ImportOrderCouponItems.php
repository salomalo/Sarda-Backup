...
class ImportOrderCouponItems extends ImportOrderItemsBase {
    ...
    public function import() {
        if (empty($this->getArticleData('ID')) or $this->getImport()->options['update_all_data'] == 'yes' or $this->getImport()->options['is_update_coupons']) {
    ...
    protected function _import_coupons_items() {
        ...
        if (!empty($this->getValue('coupons'))) {
            foreach ($this->getValue('coupons') as $couponIndex => $coupon) {
