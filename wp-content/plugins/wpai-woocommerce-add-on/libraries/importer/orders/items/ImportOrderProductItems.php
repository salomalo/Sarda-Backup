...
class ImportOrderProductItems extends ImportOrderItemsBase {
    ...
    public function import() {
        ...
        if (empty($this->getArticleData('ID')) or $this->getImport()->options['update_all_data'] == 'yes' or $this->getImport()->options['is_update_products']) {
            if (!empty($this->getArticleData('ID')) and ($this->getImport()->options['update_all_data'] == 'yes' or $this->getImport()->options['is_update_products'] and $this->getImport()->options['update_products_logic'] == 'full_update')) {
                $previously_updated_order = get_option('wp_all_import_previously_updated_order_' . $this->getImport()->id, FALSE);
                if (empty($previously_updated_order) or $previously_updated_order != $this->getArticleData('ID')) {
