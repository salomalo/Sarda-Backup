...
class ImportOrderTaxItems extends ImportOrderItemsBase {
    ...
    public function import() {
        ...
        if (empty($this->getArticleData('ID')) or $this->getImport()->options['update_all_data'] == 'yes' or $this->getImport()->options['is_update_taxes']) {
    ...
    protected function _import_taxes_items() {
        if (!empty($this->getValue('taxes'))) {
            foreach ($this->getValue('taxes') as $taxIndex => $tax) {
