...
class ImportOrderRefunds extends ImportOrderBase {
    ...
    public function import() {
        ...
        if (empty($this->getArticleData('ID')) or $this->getImport()->options['update_all_data'] == 'yes' or $this->getImport()->options['is_update_refunds']) {

            if (!empty($this->getValue('order_refund_amount'))) {
