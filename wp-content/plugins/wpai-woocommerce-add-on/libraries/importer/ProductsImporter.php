    ...
    public function afterPostImport() {
        ...
        if ($p) {
            ...
            if ($p->post_type == 'product_variation') {
                ...
                if (!empty($this->getImportService()->getProductTaxonomies())) {
                    foreach ($this->getImportService()->getProductTaxonomies() as $ctx) {
            ...
            if ($post_to_update_id){
                ...
                if ( $pid ) {
                    ...
                    if ( empty($is_variation_updated) ){
                        ...
                        // save thumbnail
                        if (empty($this->getArticleData('ID')) || $this->getImport()->options['is_update_images'] && $this->getImport()->options['update_images_logic'] == 'full_update') {
