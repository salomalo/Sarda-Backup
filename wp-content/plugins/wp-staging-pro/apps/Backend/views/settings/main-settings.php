<div class="wpstg_admin">
   ...
   <!--                                <tr class="row">
                               ...
                               <tr class="row">
                                   <td class="row th">
                                       <div class="col-title">
                                           <?php echo $form->label( "wpstg_settings[skipTransients]" ) ?>
                                           <span class="description">
                                               <?php _e( "Skip Transients for creating a new staging site and for pushing data to the live site. This increases the processing speed and can be helpful for very large databases.", "wp-staging" ); ?>

                                           </span>
                                       </div>
                                   </td>
                                   <td>
                                       <?php echo $form->render( "wpstg_settings[skipTransients]" ) ?>
                                   </td>
                               </tr>
                               <!-- Deactivated -->
                               <tr class="row">
                               ...
                               <tr class="row">
                                   <td class="row th">
                                       <div class="col-title">
                                           ...
                                           <span class="description">
                                               <?php _e( 'Select the user role you want to give access to the staging site. You can select multiple roles by holding CTRL or ⌘ Cmd key while clicking. <strong>This does not affect previously created staging sites and you need to create a new staging site if you want to change the authentication of it.</strong', 'wp-staging' ); ?>
                                           </span>
                                       </div>
                                   </td>
                                   <td>
...
<!--                               <tr class="row">
                                   ...
                                   <td>
                                       ...
                                       //echo $helper->get_home_url() . '/?' . $form->render( "wpstg_settings[loginSlug]" );
                                       ?>
                                   </td>
                               </tr>-->
                           </tbody>
