...
class SearchReplace extends \WPStaging\Backend\Modules\Jobs\JobExecutable {
   ...
   private function searchReplace( $table, $page, $args ) {
      ...
      //$this->log( 'Search: ' . $this->get_url_without_scheme( $this->options->existingClones[strtolower( $this->options->current )]['url'] ) . ' Replace: ' . $this->get_url_without_scheme( $this->homeUrlWithoutScheme ) );
