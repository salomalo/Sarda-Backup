...
class Files extends \WPStaging\Backend\Modules\Jobs\JobExecutable {
   ...
   private function copyFile( $file ) {
      ...
      // if file contains multisite upload folder e.g wp-content/uploads/sites/ID or /wp-content/blogs.dir/ID/files 
      // remove the "sites" or "blogs.dir" part and return /wp-content/uploads instead. e.g wp-content/uploads/sites/ID/2018/my-image.jpg -> wp-content/uploads/2018/my-image.jpg
      $file = $this->getUploadsStagingSource( $file );
   ...
   /**
    * Remove /wp-content/uploads/sites/7 or wp-content/blogs.dir/ID/files from the string
    * @param string $files Absolute path to the file located
    * @return string
    */
   private function getUploadsStagingSource( $file ) {
      ...
      if( false === strpos( $basedir, 'blogs.dir' ) ) {
         ...
         $newPath = str_replace( $search, $replace, $file );
      } else {
         // old blog structure
