...
wp_enqueue_style( "wri-thumbnails-" . $dimensions['size'], (get_stylesheet_directory_uri() . '/' . 'wri_template/styles-wri-thumbnails.php?' . http_build_query( array( 'width' => $dimensions['width'], 'height' => $dimensions['height'] ) ) ) );