		...
		<table class='wp-list-table wpc-conditions-post-table wpc-sortable-post-table widefat'>
			<thead>
				<tr>
					...
					<th style='padding-left: 10px;'><?php _e( 'Title', 'advanced-shipping-packages-for-woocommerce' ); ?></th>
			...
			<tbody><?php
				...
				foreach ( $shipping_packages as $shipping_package ) :
					$conditions = get_post_meta( $shipping_package->ID, '_shipping_option_conditions', true );
				...
				if ( empty( $shipping_packages ) ) :
					...
					?><tr>
						<td colspan='4'><?php _e( 'There are no Advanced Shipping Packages. Yet...', 'advanced-shipping-packages-for-woocommerce' ); ?></td>
					</tr><?php
			...
			<tfoot>
				<tr>
					<th colspan='5' style='padding-left: 10px;'>
						<a href='<?php echo admin_url( 'post-new.php?post_type=shipping_package' ); ?>' class='add button'>
							<?php _e( 'Add shipping package', 'advanced-shipping-packages-for-woocommerce' ); ?>
						</a>
					</th>
				</tr>
			</tfoot>
